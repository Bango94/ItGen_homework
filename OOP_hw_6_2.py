class rational_functions:
    ...
    def __add__(self, other):
        ...
        return rational_functions(numerator_f, common_d)

    def __sub__(self, other):
        """
        :param other:
        :return: substitution of two functions
        """
        if abs(self.a//self.b) == abs(other.a//other.b):
            return f'{(self.a * other.a)//(self.b * other.b)}'
    ...
    def __mul__(self, other):
        """
        :param other:
        :return: multiplication of two functions
        """
        if abs(self.a//self.b) == abs(other.a//other.b):
            return f'{(self.a * other.a)//(self.b * other.b)}'
    ...
    def __truediv__(self, other):
        """
        :param other:
        :return: true division of two functions
        """
        if abs(self.a//self.b) == abs(other.a//other.b):
            return f'{(self.a * other.a)//(self.b * other.b)}'
...
m1 = rational_functions(-5, 2)
m2 = rational_functions(3, 6)
